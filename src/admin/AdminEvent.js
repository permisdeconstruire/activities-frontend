...
class AdminEvent extends React.Component {
  ...
  handleSubmit(event) {
    ...
    authFetch(`${window.localStorage.getItem('PDC_AGENCE')}/v0/${typeof(this.props.type) !== 'undefined' ? this.props.type : 'cooperator'}/events`, {
      method: 'POST',
