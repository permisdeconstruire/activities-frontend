        ...
        <div className="app">
          ...
          <div className="jumbotron">
            ...
            <div className="container" style={({display: 'inline-grid', textAlign: 'center'})}>
              <Row>
                Bonjour {this.state.whoami.titre}, bienvenue chez Permis de Construire. <a href="#" onClick={logout}>Se déconnecter</a> <a href={`${window.localStorage.getItem('PDC_AGENCE')}/v0/activities.pdf`} target="_blank"> Télécharger l'agenda </a>
              </Row>
            </div>
          </div>
